...
class AdminController extends AbstractDashboardController
{
    ...
    public function indexAdmin(Request $request): Response
    {
        ...
        return $this->render('exception.html.twig', ['exception' => 'у вас нет прав']);
...
//        /yield MenuItem::linkToCrud('The Label', 'fas fa-list', EntityClass::class);
        ...
        yield MenuItem::linkToCrud('Shops', 'fas fa-comments', Shops::class);
        yield MenuItem::linkToCrud('Goods', 'fas fa-comments', Goods::class);
    }
}
